...
namespace Iamsleepingnow.Anm2Player
{
    ...
    public class AnmDebug : MonoBehaviour
    {
        ...
        [BoxGroup("Auto Load 自动加载")]
        [SerializeField] public LIBRARY.FilePathType autoLoadFilePathType = LIBRARY.FilePathType.StreamingAssets; // Anm文件路径类型 | Anm file path type
        ...
        public void LoadAnmFile(LIBRARY.FilePathType pathType, string path) {
